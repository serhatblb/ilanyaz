    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-8 max-w-md w-full text-center z-10">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-black font-semibold rounded-xl transition-all hover:bg-gray-50 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
        >
